...
public class MyDBaseConnection {
	public static void main(String[] args) throws SQLException, ClassNotFoundException {
		  //String url = "jdbc:odbc:Driver={Microsoft Access dBASE Driver (*.dbf, *.ndx, *.mdx)}";
		
		  String url = "jdbc:odbc:Driver={Microsoft dBase Driver (*.dbf)}";
